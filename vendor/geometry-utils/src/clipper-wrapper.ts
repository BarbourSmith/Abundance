...
export default class ClipperWrapper {
    ...
    public generateTree(memSegs: Float32Array[], useHoles: boolean): PolygonNode[] {
        ...
        if (useHoles) {
            // If using holes interpret enclosed polygons as voids within their parent.
            // Restructure 'nodes' to be a tree of parent/child relationships instead of a flat list
    ...
    public static fromMemSeg(memSeg: Float32Array, offset: Point<Float32Array> = null, isRound: boolean = false): PointI32[] {
